...
export default function DepartmentsPage() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => getDepartments(enterpriseId!),
  ...
  const addMutation = useMutation({
    mutationFn: (formData: DepartmentFormData) =>
      addDepartment({ ...formData, enterprise_id: enterpriseId! }),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (formData: DepartmentFormData) =>
      updateDepartment({ ...formData, id: editingDepartment!.id, enterprise_id: enterpriseId! }),
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) => deleteDepartment(id, enterpriseId!),
    onSuccess: () => {
      ...
      render: (_, record) => (
        <Space>
          ...
          <Popconfirm
            ...
            description="This will affect all employees in this department."
