"""Generate ONE clean single-sheet Excel for Employee tests.
Same logic as build_enterprise_excel.py but reads docs/ERP_Employee.md and emits ERP_Employee.xlsx.
"""
...
OUT = os.path.join(HERE, "ERP_Employee.xlsx")
FALLBACK = os.path.join(HERE, "ERP_Employee.locked.xlsx")
...
def write_workbook(rows, out_path):
    ...
    title_fill = PatternFill("solid", fgColor="065F46")  # emerald-800 to differentiate from admin
    header_font = Font(bold=True, color="FFFFFF", size=11)
    header_fill = PatternFill("solid", fgColor="1F2937")
    section_font = Font(bold=True, color="065F46", size=12)
    section_fill = PatternFill("solid", fgColor="D1FAE5")  # emerald-100
    ...
    c = ws["A1"]
    c.value = "ERP — Employee · Test Cases"
    c.font = title_font
    c.fill = title_fill
    c.alignment = center
    ...
    c.value = (
        ...
        "Permission-deny tests are first-class — log any failure as P0 SECURITY. "
        "Source: docs/ERP_Employee.md."
    )
    ...
    headers = [
        "TC #", "Section", "Flow", "Step / Persona", "Action / Test Data",
    ...
    widths = {"A": 11, "B": 32, "C": 38, "D": 14, "E": 50, "F": 60, "G": 13, "H": 35, "I": 30}
